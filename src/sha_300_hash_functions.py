...
class SHA_300:
    ...
    def sha3_224_file_hash_hex(self, file):
        file_to_hash = open(file, "rb")
        data = file_to_hash.read()
        file_to_hash.close()
    ...
    def sha3_256_file_hash_hex(self, file):
        file_to_hash = open(file, "rb")
        data = file_to_hash.read()
        file_to_hash.close()
    ...
    def sha3_384_file_hash_hex(self, file):
        file_to_hash = open(file, "rb")
        data = file_to_hash.read()
        file_to_hash.close()
    ...
    def sha3_512_plaintext_hash_bytes(self, plaintext):
        sha3_512_object = hashlib.sha3_512()
        sha3_512_object.update(plaintext)
        hash_bytes = sha3_512_object.digest()
        return hash_bytes
    
    def sha3_512_plaintext_hash_hex(self, plaintext):
        sha3_512_object = hashlib.sha3_512()
        sha3_512_object.update(plaintext)
        hash_hex = sha3_512_object.hexdigest()
        return hash_hex
    
    def sha3_512_file_hash_bytes(self, file):
        file_to_hash = open(file, "rb")
        data = file_to_hash.read()
        file_to_hash.close()
    ...
    def sha3_512_file_hash_hex(self, file):
        file_to_hash = open(file, "rb")
        data = file_to_hash.read()
        file_to_hash.close()
    ...
    def sha224_plaintext_hash_hex(self, data):
        sha3_224_object = hashlib.sha3_224()
        sha3_224_object.update(data)
        hex_digest = sha3_224_object.hexdigest()
        return hex_digest
    
    def sha256_plaintext_hash_hex(self, data):
        sha3_256_object = hashlib.sha3_256()
        sha3_256_object.update(data)
        hex_digest = sha3_256_object.hexdigest()
        return hex_digest
    
    def sha384_plaintext_hash_hex(self, data):
        sha3_384_object = hashlib.sha3_384()
        sha3_384_object.update(data)
        hex_digest = sha3_384_object.hexdigest()
        return hex_digest
    
    def sha512_plaintext_hash_hex(self, data):
        sha3_512_object = hashlib.sha3_512()
        sha3_512_object.update(data)
        hex_digest = sha3_512_object.hexdigest()
        return hex_digest
    
    def sha224_plaintext_hash_bytes(self, data):
        sha3_224_object = hashlib.sha3_224()
        sha3_224_object.update(data)
        byte_digest = sha3_224_object.digest()
        return byte_digest
    
    def sha256_plaintext_hash_bytes(self, data):
        sha3_256_object = hashlib.sha3_256()
        sha3_256_object.update(data)
        byte_digest = sha3_256_object.digest()
        return byte_digest
    
    def sha384_plaintext_hash_bytes(self, data):
        sha3_384_object = hashlib.sha3_384()
        sha3_384_object.update(data)
        byte_digest = sha3_384_object.digest()
        return byte_digest
    
    def sha512_plaintext_hash_bytes(self, data):
        sha3_512_object = hashlib.sha3_512()
        sha3_512_object.update(data)
        byte_digest = sha3_512_object.digest()
        return byte_digest
